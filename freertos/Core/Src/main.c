...
/* USER CODE BEGIN Header_StartBlinkLED0 */
/**
* @brief Function implementing the blinkLED0 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartBlinkLED0 */
void StartBlinkLED0(void const * argument)
{
  /* USER CODE BEGIN StartBlinkLED0 */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
...
void StartBlinkLED1(void const * argument)
{
  /* USER CODE BEGIN StartBlinkLED1 */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
